...
// let fruitArray = ["apple", "Banana", "Mango", "cherry"];

// console.log(fruitArray.includes("banana"), fruitArray.indexOf("Mango"));
...
async function fetchListOfProducts() {
  try {
    ...
    // Pass the products to the renderProduct function
...
function renderProduct(getProducts) {
  // Map through the products and join them into a single string
